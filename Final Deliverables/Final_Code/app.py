...
def login():
    if (request.method == "POST") and ('email_name' in request.form) and ('user_password' in request.form):
        ...
        if (email_name=="admin@gmail.com") and (user_password=="123456"):
            ...
            return "There Was an issue while Login to Portal..Enter Proper Credientials"
